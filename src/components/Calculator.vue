    ...
    <main>
        <div class="container">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input v-model="inputAmount" class="form-control text-center" id="inputEmail3" placeholder="Amount">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword3" class="col-sm-6 col-form-label">TAE</label>
                <div class="col-sm-6">
                <input v-model="inputTAE" class="form-control text-center" id="inputPassword3" placeholder="% TAE">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="row justify-content-md-center monthly-payment mb-5">
                ...
                <input v-model="monthlyPayment" class="col-sm-9 text-center month-paymeny-input" disabled="true">
            </div>
...
export default {
    ...
    methods: {
        calculateMonthlyPayment(){
            ...
            this.interestPercentage = ((monthlyPayment * years * 12 - amount) / amount * 100).toFixed(2) + '%'
